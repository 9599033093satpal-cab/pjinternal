...
TYPE_FIELD_MAP = {
    ...
    "leave_license_agreement": ["licensor", "licensee", "property_address", "rent_amount", "deposit_amount", "agreement_date", "duration_months"],
    "offer_letter": ["candidate_name", "company_name", "joining_date", "salary_ctc", "designation"],
    "insurance_policy": ["policy_number", "insured_name", "sum_assured", "premium", "nominee", "policy_period"],
    "schedule": ["schedule_number", "description", "effective_date", "reference_agreement"],
    "financial_clauses": ["interest_rate", "emi", "loan_amount", "repayment_terms", "penalty_rate"],
